...
namespace picosystem {
  ...
  enum _sprites_ids {
    ...
    // 40+
    HEART1, SLIME, COIN2, SWORD4, SWORD5, __SPR45, DYNAMITE, MEDPACK,
    // 48+
    GOGGLES, HELMET5, BOMB, OILCAN, SHIRT1, SHIRT2, SPEECH, DREAM,
    // 50+
    HEART2, HEART3, HEART4, __SPR53, TORCH, ICE, CARD, DIE,
    // 58+
    ...
    // D8+
    BRICK2, BRICK3, SHRIMP, __SPR_DA, CURSOR2, BLUEDOT, __SPR_DE, __SPR_DF,
    // E0+
